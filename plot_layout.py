...
cmd = "./plot_fast_net.py RD %s layout-rd.pdf" % (" ".join(args) )
print cmd
run_proc(cmd,False)

cmd = "./plot_fast_net.py WR %s layout-wr.pdf" % (" ".join(args) )
print cmd
run_proc(cmd,True)

cmd = "./plot_fast_net.py APRD %s layout-aprd.pdf" % (" ".join(args) )
print cmd
run_proc(cmd,False)

cmd = "./plot_fast_net.py APWR %s layout-apwr.pdf" % (" ".join(args) )
print cmd
run_proc(cmd,True)
