...
cmd = "./plot_fast_net.py RD %s prefetch-rd.pdf" % (" ".join(args) )
print cmd
run_proc(cmd,False)

cmd = "./plot_fast_net.py WR %s prefetch-wr.pdf" % (" ".join(args) )
print cmd
run_proc(cmd,True)

cmd = "./plot_fast_net.py APRD %s prefetch-aprd.pdf" % (" ".join(args) )
print cmd
run_proc(cmd,False)

cmd = "./plot_fast_net.py APWR %s prefetch-apwr.pdf" % (" ".join(args) )
print cmd
run_proc(cmd,True)
